...
- 🎯 **PROCHAIN TICKET : [FT-4B]** (https://trello.com/c/3mjx0M31, Todo) — saisie du score, confirmation, litige. Passation complète en commentaire de la carte. Le gros morceau : le runner d'audit ne fait aujourd'hui **aucun** appel système (tout passe par HTTP) et il lui faut un helper SQL pour fabriquer un match prêt à être scoré. Le scénario tourne sur un ladder **1v1** (2 comptes jetables au lieu de 10).
