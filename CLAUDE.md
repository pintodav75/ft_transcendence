...
- ✅ **Tests — deux niveaux, deux outils** (`backend/tests/`) :
  ...
  - **End-to-end (Python, stdlib seule)** — `cd backend/tests && python3 run_all.py` : **14 suites, 501 cas** (mesuré 24/07 : **501 ✅ / 0 ❌** — inclut `test_social_data.py` 38 cas (B-Social-Data) et la correction de 2 faux rouges — voir ci-dessous)
