...
### ⚠️ Le minor qui n'est PAS acquis (audit contre le PDF, 22/07)

Le sujet est explicite : *« You will be asked to demonstrate each claimed module. Only fully functional and properly implemented modules will be counted. **Non-functional or incomplete modules = 0 points.** »* Les 10 autres modules du tableau sont couverts par le back. Celui-ci ne l'est pas encore :
