...
│   ├── tests/               # tests e2e Python (run_all.py — 13 suites, 463 cas) + unit/ (Vitest) + README
...
- ✅ **Tests — deux niveaux, deux outils** (`backend/tests/`) :
  ...
  - **End-to-end (Python, stdlib seule)** — `cd backend/tests && python3 run_all.py` : **13 suites, 463 cas** (mesuré 24/07 : **463 ✅ / 0 ❌** après correction de 2 faux rouges — voir ci-dessous)
