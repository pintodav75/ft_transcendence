...
export function HeroBanner() {
  return (
    ...
    >
      ...
      <div className="max-w-155 px-8 py-12 md:px-12 md:py-16">
        <p className="text-xs font-bold uppercase tracking-[0.25em] text-success">
          Compete across 5 games
        </p>
        <h2 className="mt-4 font-display text-5xl font-black uppercase leading-[0.95] text-text-primary md:text-6xl">
          Compete.
          <br />
          Climb.
          <br />
